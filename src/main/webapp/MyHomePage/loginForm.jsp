	...
	<div class="formBox">
		<div class="formlogin">
			<div>
				...
				<input id="id" name="id" class="id" placeholder="" type="text">        
			</div>
			<div>
		...
		<div class="option">
			<span class="auto">
				<input id="use_login_keeping" name="use_login_keeping" value="T" type="checkbox">
		...
		<div class="LoginArea">
			<button type="button" class="btnSubmit">로그인</button>
		</div>
		<!--
		<div class="LoginArea">
